...
describe('the handlebars extensions', () => {
  describe('localization', () => {
    it('should translate placeholders', () => {
      ...
      const result = renderer.render(context, HTML_CONTENT_TYPE);
  ...
  describe('numbers', () => {
    it('should resolve placeholders', () => {
      ...
      const result = renderer.render({}, TEXT_CONTENT_TYPE);
  ...
  describe('datetimes', () => {
    it('should format timestamps', () => {
      ...
      const result = renderer.render(context, TEXT_CONTENT_TYPE);
